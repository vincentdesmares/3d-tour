...
var Sky = function Sky() {
  ...
  _three.Mesh.call(this, new _three.BoxBufferGeometry(1, 1, 1), material);
};

Sky.prototype = Object.create(_three.Mesh.prototype);
...
Sky.SkyShader = {
  uniforms: {
    ...
    sunPosition: { value: new _three.Vector3() }
  },
