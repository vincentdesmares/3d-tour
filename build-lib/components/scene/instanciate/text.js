...
exports.default = function(scene, sceneState, font, threeState) {
  var text
  var color = 0x000000
  threeState.matTransparent = new _three.MeshBasicMaterial({
    color: color,
    transparent: true,
    opacity: 0,
  ...
  try {
    for (
      var _iterator = sceneState.sentences[Symbol.iterator](), _step;
      ...
      if (sentence.displayAfterScrollStart) {
        text = new _three.Mesh(textShape, threeState.matTransparent)
      } else {
